      ...
      <div>
        ...
        <form ref={formRef} onSubmit={addEvent}>
          ...
          <select name="group" id="group">
            <option value="-">-</option>
            {groups.map((group) => (
              <option key={group._id} value={group.name} name="group" required>
                {group.name}
              </option>
            ))}
          </select>
        ...
        <div className={styles.description}>
          ...
          <p>
            ...
            todos los miembros del grupo y los eventos que han sido rechazados.
          </p>
          <p>
            Cuando un evento es rechazado por una persona automaticamente queda
            rechazado al igual que si un evento se acepta por todos los miembros
            del grupo el evento pasa automaticamente a la lista de confirmados.
          </p>
        </div>
      </div>
